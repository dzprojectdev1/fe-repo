...
export default class VideoPlayer extends Component {
  ...
  onEnd(event) {
    ...
    if (this.props.endWithThumbnail) {
      ...
      if (this.props.onFullscreen) this.props.onFullscreen(false);
  ...
  renderStartButton() {
    ...
    return (
      <TouchableOpacity
        ...
        <Image
          source={require('../../images/safetystudy_play.png')}
          style={{width: 68 * em, height: 68 * em}}
        />
      </TouchableOpacity>
    );
  }
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            style={{width: 24 * em, height: 29 * em}}
          />
        </TouchableOpacity>
        <Text style={{paddingLeft: 30 * em, fontSize: 26 * em, color: '#fff'}}>
        ...
        <Text style={{paddingRight: 32 * em, fontSize: 26 * em, color: '#fff'}}>
        ...
        <TouchableOpacity
          ...
          <Image
            source={require('../../images/size_scale.png')}
            style={{width: 30 * em, height: 29 * em}}
          />
        </TouchableOpacity>
      </View>
    );
  ...
  renderVideo() {
    ...
    return (
      <View style={customStyles.videoWrapper}>
        ...
        {!this.props.hideControlsAllways
