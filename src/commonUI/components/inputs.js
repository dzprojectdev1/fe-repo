    ...
    return (
      <View style={formStyles.formField}>
        <Image
          ...
          style={{width: 40 * em, height: 40 * em, margin: 25 * em}}
        />
        <TextInput
          placeholder={this.props.placeholder}
          onChangeText={this.onChangeField.bind(this)}
          style={[formStyles.fieldText, {width: 468 * em}]}
          secureTextEntry={!!this.props.passwordField}
        />
      </View>
    );
...
export class CheckField extends Component {
  render() {
    ...
    if (!checked) {
      checkedImage = require('../images/checkbox_unchecked.png');
    }
        ...
        <View style={formStyles.fieldLabelWrapper}>
          <Text
            style={[
              ...
              {fontSize: 28 * em, color: '#000', marginLeft: -18 * em},
            ]}>
            {this.props.label}
          </Text>
        </View>
        <View
          style={{flexDirection: 'row', width: '75%', position: 'relative'}}>
          <Picker
            ...
            onResult={this.onChangeField.bind(this)}
          />
        </View>
      </View>
    );
...
export class SelectFieldMy extends Component {
  ...
  render() {
    ...
    let rootStyle = {
      ...
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: this.props.rightAligned ? 'space-between' : 'flex-start',
      width: '100%',
      height: HEIGHT_INPUTFIELD,
    };
      ...
      <View style={rootStyle}>
        ...
        <View
          style={{
            flexDirection: 'row',
            alignItems: 'center',
            justifyContent: this.props.rightAligned
              ? 'flex-end'
              : 'space-between',
          }}>
          <Picker
            ...
            inputStyle={{
              borderWidth: 0,
              width: this.props.rightAligned ? 400 * em : 500 * em,
              marginRight: 10 * em,
              alignItems: 'flex-start',
              textAlign: 'left',
            }}
            pickerNameStyle={{color: '#333333', fontSize: 26 * em}}
            confirmBtnStyle={{color: colors.primary, fontSize: 26 * em}}
            cancelBtnStyle={{color: colors.primary, fontSize: 26 * em}}
            textStyle={textStyle}
            inputValue={!this.props.value ? this.props.placeholder : value}
            pickerName={this.props.pickerName ? this.props.pickerName : ''}
            selectIndex={this.props.selectIndex ? this.props.selectIndex : [1]}
          ...
          <Image
            ...
            style={{width: 10 * em, height: 19 * em}}
          />
        </View>
      </View>
    );
    ...
    return (
      <View style={rootStyle}>
        ...
        <View
          ...
          <Picker
            textStyle={{fontSize: 28 * em, color: '#333'}}
            placeholder={this.props.placeholder}
            inputValue={value}
            inputStyle={{
              borderWidth: 0,
...
export class DateField extends Component {
  ...
  render() {
    return (
      <View style={formStyles.formField}>
        <View style={formStyles.fieldLabelWrapper}>
          <Text style={formStyles.fieldLabel}>{this.props.label}</Text>
        </View>
        <View style={{width: '75%'}}>
          {/*
      ...
      <View style={formStyles.formField}>
        ...
        <View
          ...
          <InputField
            ...
            style={{width: 215 * em}}
            mode="date"
            date={this.props.fromValue}
            format="YYYY.MM.DD"
            showIcon={false}
            customStyles={{dateInput: {borderWidth: 0}}}
            onDateChange={this.onChangeFromField.bind(this)}
          />
          <Image
          ...
          <InputField
            ...
            style={{width: 215 * em}}
            mode="date"
            date={this.props.toValue}
            format="YYYY.MM.DD"
            showIcon={false}
            customStyles={{dateInput: {borderWidth: 0}}}
            onDateChange={this.onChangeToField.bind(this)}
          />
          <Image
            source={require('../images/calender.png')}
            style={{
    ...
    return (
      <View style={fixedFormStyles.formField}>
        <View style={fixedFormStyles.fieldLabelWrapper}>
          <Text style={fixedFormStyles.fieldLabel}>{label}</Text>
        </View>
        <View style={fixedFormStyles.fieldTextWrapper}>
          {isEmptyField ? (
            <Text
              style={[
                fixedFormStyles.fieldPlaceholder,
                onChangeField ? {paddingRight: 22 * em} : {},
              ]}>
              {placeholder}
            </Text>
          ) : (
          ...
          {onChangeField ? (
            <TouchableOpacity
              style={{position: 'absolute', top: 38 * em, right: 0}}
              onPress={this.onChangeField.bind(this, value)}>
    ...
    return (
      <View style={formStyles.formField}>
        ...
        <View
          ...
          <Image
            source={require('../images/calender.png')}
            style={{width: em * 24, height: em * 24}}
          />
        </View>
        <View
          style={{
  ...
  render() {
    ...
    return (
      <View style={[fixedFormStyles.formField, {height: HEIGHT_INPUTFIELD}]}>
        {this.props.required ? (
          <View
            style={[{width: '45%', flexDirection: 'row', paddingTop: 18 * em}]}>
            <Text
              style={{color: 'red', paddingRight: 5 * em, paddingTop: 7 * em}}>
              *
            </Text>
        ...
        <View
          ...
          {isEmptyField ? (
            ...
            <Text
              style={[
                {color: '#666666', fontSize: 28 * em, textAlign: 'right'},
                onChangeField ? {paddingRight: 22 * em} : {},
              ]}>
              {value}
            </Text>
          ...
          {onChangeField ? (
            <TouchableOpacity
              style={{position: 'absolute', top: 30 * em, right: 0}}
              onPress={this.onChangeField.bind(this, value)}>
              <Image
