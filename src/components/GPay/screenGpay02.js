...
import Gpaybutton from '../../assets/images/GooglePay_mark_800_gray_3x.png'
...
class screenGpay02 extends Component {
  ...
  onBuy(){
    ...
    Global.saveData.gem_price = PaypriceListVal[this.state.number];
    Global.saveData.gem_number = GempriceListVal[this.state.number];
    
    this.props.navigation.navigate("screenGpay03", {
      CLICK_NUMBER: this.state.number,
      TOTAL_NUMBER: GempriceListVal[this.state.number],
      TOTAL_PRICE: PaypriceListVal[this.state.number]
    });
  }
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.dialog_screen}>
          ...
          <View style={{height:40, width:'100%', borderBottomWidth: 1 , borderBottomColor:'gray', flexDirection:'row', alignItems:'center'}}>
            ...
            <Text style={{color:'#000', fontSize:8, marginLeft: 5}}>{Global.saveData.u_email}</Text>
