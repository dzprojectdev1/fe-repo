            ...
            <View style={{flexDirection: 'row', marginLeft: 20, width: 200}}>
              ...
              <Text
                style={{
                  fontSize: 16,
                  marginRight: 20,
                }}>{`My Fans (${this.state.fanUsersCount})`}</Text>
            </View>
            <Image
              source={this.state.showFanUsers ? collapse : expand}
              style={{width: 15, height: 15, marginTop: 3, marginRight: 20}}
            />
          </TouchableOpacity>
            ...
            <View style={{flexDirection: 'row', marginLeft: 20, width: 200}}>
              ...
              <Text
                style={{
                  fontSize: 16,
                  marginRight: 20,
                }}>{`My Stars (${this.state.starUsersCount})`}</Text>
            </View>
            <Image
              source={this.state.showStarUsers ? collapse : expand}
              style={{width: 15, height: 15, marginTop: 3, marginRight: 20}}
            />
          </TouchableOpacity>
                      ...
                      {rowData.fanMessage != '' && (
                        <View style={styles.fanMessage}>
                          <Text
                            ...
                            {'My fan message "' + rowData.fanMessage + '"'}
                          </Text>
                        </View>
                      )}
                    </View>
