...
class VoiceCall extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      opponentAppInfo: props.route.params.data.opponentAppInfo,
      hours: 0,
      minutes: 0,
      seconds: 0,
      intervalId: 0,
    ...
    return (
      <ImageBackground source={bg} style={styles.contentContainer}>
        <View style={{justifyContent: 'center', alignItems: 'center'}}>
          <Image
            source={
              state.opponentAppInfo.imgUrl
                ? {uri: state.opponentAppInfo.imgUrl}
                : hiddenMan
            }
          ...
          <View
            ...
            <TouchableOpacity
              style={{width: 30}}
              onPress={() => this.setState({speaker: !state.speaker})}>
              <Image
                source={!state.speaker ? speaker : speaker_mute}
