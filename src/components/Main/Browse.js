...
class Browse extends Component {
  ...
  getDetails = async data => {
    ...
    if (data.cdn_filtered_id && data.content_type == 1) {
      ...
      otherData = {};
      const v_url =
        `${SERVER_URL}/api/storage/videoLink?fileId=` + data.cdn_filtered_id;
      await fetch(v_url, {
        method: 'GET',
        headers: {
      ...
      <View style={styles.contentContainer}>
        ...
        {this.state.noMoreUsers ? (
          ...
          <View>
            ...
            {this.state.otherData.imageUrl == null &&
              this.state.otherData.videoUrl == null && (
                <TouchableOpacity onPress={this.gotoProfile}>
                  <View
                    style={{
              ...
              <View
                ...
                <View
                  ...
                  <Text
                    ...
                    {this.state.otherData.detail.coin_per_message +
                      ' per message'}
                  </Text>
                </View>
                {/*<View style={{flexDirection: 'row', marginTop: 5}}>*/}
