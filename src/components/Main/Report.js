    ...
    return (
       <View style={styles.contentContainer}>
          ...
          {/* <View style={{width:DEVICE_WIDTH*0.8,marginLeft:DEVICE_WIDTH*0.1, marginTop:50}}> 
                 <Text style={{fontSize:16, fontWeight:'bold'}}>{"DESCRIBE THE PROBLEM"}</Text>           
                 <TextInput                            
                       style={{backgroundColor:'transparent', width:DEVICE_WIDTH*0.8, paddingLeft:10, height:40, paddingLeft:2, color:'#000'}}
                       selectionColor="#009788"
                       value ={this.state.problem_title}
                       placeholder="Please describe your problem here"
                       placeholderTextColor="#808080"
                       onChangeText={problem_title => this.setState({ problem_title })}
                       autoCapitalize="none"
           ...
           <View style={{width:DEVICE_WIDTH*0.8,marginLeft:DEVICE_WIDTH*0.1, marginTop:30}}> 
                 ...
                 <TextInput                            
                       style={{backgroundColor:'transparent', width:DEVICE_WIDTH*0.8, height:180,
