  ...
  render() {
    ...
    return (
       <View style={styles.contentContainer}>
        ...
        <View style={{position:'absolute', left:0, bottom:100, height:40, width:DEVICE_WIDTH,
                  alignItems:'center', justifyContent:'center'
                   }}>
           <Text style={{fontSize:18, color:'#DE5859'}}>{this.state.recordTimeText}</Text>
        </View>)}
        <View
          style={{position:'absolute', left:0, bottom:30, height:40, width:DEVICE_WIDTH, flexDirection:'row', 
                  alignItems:'center', justifyContent:'center'
                   }}
        >
