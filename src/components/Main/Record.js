  ...
  render() {
    return (
      <View style={styles.contentContainer}>
        ...
        {/*{this.state.isRecorded && (*/}
        {/*  <Video*/}
        {/*    source={{uri: this.state.recordedUri}} // Can be a URL or a local file.*/}
        {/*    ref={ref => {*/}
        {/*      this.player = ref;*/}
        {/*    }}*/}
        ...
        {this.state.recording && (
          <View
            ...
            <Text style={{fontSize: 18, color: '#DE5859'}}>
              {this.state.recordTimeText}
            </Text>
          </View>
        )}
        <View
          ...
          <View
            style={{
              ...
              height: 60,
              flexDirection: 'row',
              justifyContent: this.state.isRecorded
                ? 'space-between'
                : 'center',
            }}>
            ...
            {!this.state.isRecorded && (
              ...
              >
                <Image
                  source={this.state.recording ? b_stop : recordImg}
                  style={{width: 60, height: 60, marginLeft: 27}}
                />
              </TouchableOpacity>
            )}
            {!this.state.isRecorded && !this.state.recording && (
              ...
              >
                <Image
                  source={switching_camera}
                  style={{width: 85, height: 85, marginTop: -12}}
                />
              </TouchableOpacity>
            )}
            {!this.state.isRecorded && this.state.recording && (
