              ...
              if (!responseJson.error) {
                ...
                Alert.alert(
                  ...
                  [
                    {
                      text: 'Ok',
                      onPress: () => console.log(responseJson.message),
                    },
                  ],
                  {cancelable: true},
                );
        ...
        <Content>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              {this.state.remberCheck && (
                <Image source={checkIcon} style={{width: 15, height: 15}} />
              )}
              {!this.state.remberCheck && (
                <Image source={uncheckIcon} style={{width: 15, height: 15}} />
              )}
              <Text
                style={{
                  color: '#000',
